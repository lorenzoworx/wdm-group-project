...
const Announcements = () => {
  ...
  const canManageAnnouncements = userType === 'admin' || userType === 'instructor';
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditingAnnouncement({ ...editingAnnouncement, department: e.target.value })}
                    className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="CS">CS</option>
                    <option value="IT">IT</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingAnnouncement({ ...editingAnnouncement, tags: e.target.value.split(',').map(tag => tag.trim()).filter(tag => tag) })}
                    className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <label htmlFor="editIsPinned" className="text-sm text-gray-700">
                    Pin this announcement
                  </label>
                </div>
              </div>
