...
$DB_NAME = env('DB_NAME') ?: env('MYSQL_DATABASE') ?: env('DB_DATABASE') ?: null;
$DB_USER = env('DB_USER') ?: env('MYSQL_USER') ?: env('DB_USERNAME') ?: null;
$DB_PASS = env('DB_PASS') ?: env('MYSQL_PASSWORD') ?: env('DB_PASSWORD') ?: null;
